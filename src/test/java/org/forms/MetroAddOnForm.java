...
public class MetroAddOnForm {
	...
	public void validation(String howToEnterApp, String MobileNum, String cardNum, String cardHoldNum, String updateYes,
			String newEmail,String UserRequireForm, String EligbleAccesCount, String appliName1, String appliMobNum1, String appliEmail1,
		...
		String userLikeForm = UserRequireForm ;

		if (userLikeForm.equalsIgnoreCase("ADDON")) {
	...
	private void listening(ITestResult result) throws IOException {
		...
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			try {
				ScreenshotPath = MetroAddOnForm.getScreenshot(driver, result.getName());
			} catch (IOException e) {
				e.printStackTrace();
			}
