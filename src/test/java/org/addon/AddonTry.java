...
public class AddonTry {
	...
	private void reportsStart() {
		...
		extent.addSystemInfo("Project Name", "Interiors Furniture");
	...
	public void validation(String howToEnterApp, String MobileNum, String cardNum, String cardHoldNum, String newEmail,
			String updateYes) throws InterruptedException {
		...
		if (HowToLikeEnteringInTheApplication.equalsIgnoreCase("mobile")) {
			...
			mobileNumber.sendKeys(MobileNum); // 9361310727
		} else {
			cardNumber.sendKeys(cardNum); // 4500308916 //1600322912 ref
		}
	...
	@Test(priority = 2, enabled = true, dataProvider = "common")
	public void addOnCustomer(int EligbleAccesCount, String appliName1, String appliMobNum1, String appliEmail1,
			String appliName2, String appliMobNum2, String appliEmail2, String appliName3, String appliMobNum3,
			String appliEmail3, String appliName4, String appliMobNum4, String appliEmail4)
		...
		try {
			...
			int HowMuchEligbleLikeToYouGive = EligbleAccesCount;
	...
	@Test(priority = 2, enabled = false, dataProvider = "common")
	public void referAFriend(String referCount, String cardHoldName, String cardHoldMobNum, String cardHoldEmail,
			String referCusName1, String referedCusMobNum1, String referCusEmaiID1, String referCusName2,
			String referedCusMobNum2, String referCusEmaiID2, String referCusName3, String referedCusMobNum3,
			String referCusEmaiID3, String referCusName4, String referedCusMobNum4, String referCusEmaiID4,
			String referCusName5, String referedCusMobNum5, String referCusEmaiID5) throws InterruptedException {
